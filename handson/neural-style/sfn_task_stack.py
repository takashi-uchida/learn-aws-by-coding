...
class SfnTaskStack(Stack):

    def __init__(self, scope: Construct, construct_id: str, props: SfnTaskStackPrpops, **kwargs) -> None:
        ...
        batch_task = tasks.BatchSubmitJob(self, "Submit Job",
            ...
            job_queue_arn=props.job_queue.job_queue_arn,
        ...
        waitX = sfn.Wait(self, "Wait 10 seconds", time=sfn.WaitTime.duration(cdk.Duration.seconds(10)))
        ...
        state_machine = sfn.StateMachine(
            self, "StateMachine",
            definition_body=sfn.DefinitionBody.from_chainable(sfn_chain),
